...
class Psr7HmacAuthenticator implements SimplePreAuthenticatorInterface
{
    ...
    public function createToken(Request $request, $providerKey)
    {
        ...
        // prevent DiactorosFactory::createRequest from
        // locking the content out from subsequent Request
        // client code.
        $request->getContent();
    ...
    public function authenticateToken(TokenInterface $token, UserProviderInterface $userProvider, $providerKey)
    {
        ...
        if (!$apiUser instanceof ApiUserInterface || !$apiUser instanceof UserInterface) {
